...
def get_top_10_records():
    ...
    if conn:
        ...
        cursor.execute("SELECT id, crop_name, planting_date, harvest_date, growth_stage, pest_control_measures, yield_prediction FROM crops ORDER BY id ASC LIMIT 1000000")
